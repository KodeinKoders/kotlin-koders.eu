...
data class Schedule(
    ...
    companion object : DataHolder<Schedule>() {
        ...
        val loft by Schedule(listOf(
            ...
            Slot(11, 20, Talk.ArrowMetaSerialization),
            Slot(12, 20, Talk.FunctionalInSpringBoot),
            Slot(13, 20, Talk.CICDWithKotlin),
            Slot(13, 50, Talk.QuickStartKMP),
            Slot(14, 20, Talk.ExploringAdvancedCompose),
            Slot(15, 20, Talk.AnimatingCompose),
            Slot(15, 50, Talk.Break),
            Slot(16, 20, Talk.KotlinNativeFromTheTrenches),
