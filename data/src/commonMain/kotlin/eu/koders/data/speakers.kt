...
data class Speaker(
    ...
    companion object : DataHolder<Speaker>() {
        ...
        val SergeyRyabov by Speaker(
            name = "Sergey Ryabov",
            bio = """
                    Sergey is a developer from London who paused his nomadic lifestyle to feel the scale and peculiarities of working in Big Tech for himself.
                    At Facebook, he works on Android UI Frameworks, Backend-Driven UI, and helps with the implementation of Kotlin into the largest mobile codebase.
                    
                    In the past, he was involved in the organization of the Kotlin User Group in St. Petersburg and the Android Academy schools in St. Petersburg and Moscow.
                    Has been writing in Kotlin since traits.
                """.trimIndent(),
            company = "Facebook",
            twitter = "colriot"
        )
        val DmitryKandalov by Speaker(
            ...
            bio = """
                    Dmitry has been programming since DOS times.
                    He spent the last 15 years or so in Java lands most recently working with server-side Kotlin.
                """.trimIndent(),
            company = "Code Mine"
        )
        ...
        val ThomasPucci by Speaker(
            name = "Thomas Pucci",
            bio = """
                    Former React-Native expert, I jumped in Kotlin Android App development 3 years ago.
                    I work at BAM as Head of Native and manage several developer teams working in Kotlin and Swift.
        ...
        val AydarMukhametzyanov by Speaker(
            ...
            bio = """
                I had been developing iOS applications since iOS 5 in a mobile agency, in a large and cozy 2GIS, and Freeletics in Munich.
                
                I currently work at JetBrains, AppCode team, but still remember how it feels to be a mobile developer. 
